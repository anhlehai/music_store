...
public class Song extends AudioContent implements Comparable<Song>// implement the Comparable interface 
{
	...
	{
		super.printInfo();
		System.out.println("Artist: "+ artist + " Composer: "+composer+" Gener: "+genre);
	}
	...
	public boolean equals(Object other)
	{
		...
		return super.equals(other) && composer.equals(otherCon.composer) && artist.equals(otherCon.artist);
		//return false;
	}
